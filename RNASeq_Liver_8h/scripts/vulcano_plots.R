...
#Determine a new column to be able to color the entries accordingly with their cateogryashr_de1$threshold<-"NoVariance"
...
#Produce the plot & save it as eps
setEPS()
...
ashr_de3$threshold<-factor(ashr_de3$threshold, 
                          levels(ashr_de3$threshold)[c(2,1)])
...
save.image(file = paste0("environments/Vulcano_Plots_NoLi61_",Sys.Date(),".RData",sep=""))