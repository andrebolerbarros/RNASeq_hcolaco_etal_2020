...
tiff("Vulcano_Plots/VP_PBSInf_vs_PBSNonInf.tiff", width = 1500, height = 1000,res = 200)
...
tiff("Vulcano_Plots/VP_DoxyNonInf_vs_PBSNonInf.tiff", width = 1500, height = 1000,res = 200)
...
tiff("Vulcano_Plots/VP_DoxyInf_vs_PBSInf.tiff", width = 1500, height = 1000,res = 200)
...
tiff("Vulcano_Plots/VP_PhenNonInf_vs_PBSNonInf.tiff", width = 1500, height = 1000,res = 200)
...
tiff("Vulcano_Plots/VP_PhenInf_vs_PBSInf.tiff", width = 1500, height = 1000,res = 200)
...
tiff("Vulcano_Plots/VP_EpiNonInf_vs_PBSNonInf.tiff", width = 1500, height = 1000,res = 200)
...
tiff("Vulcano_Plots/VP_EpiInf_vs_PBSInf.tiff", width = 1500, height = 1000,res = 200)
